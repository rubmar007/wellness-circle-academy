 ...
 * @var array<string,mixed>|null  $noticia
 * @var array<string,string>      $errors
 * @var array<string,string>      $old
 * @var string $csrf
 */
$isCreate  = $mode === 'create';
$pageTitle = $isCreate ? 'Nueva noticia' : 'Editar noticia';
$action    = $isCreate ? '/admin/noticias' : '/admin/noticias/' . (int) $noticia['id'];
?>
...
<form method="post" action="<?= e($action) ?>" class="admin-form" enctype="multipart/form-data" novalidate>
        ...
        <div class="field">
            ...
            <?php if (!empty($noticia['image_path'])): ?>
                <div class="current-image-preview">
                    <img src="<?= e($noticia['image_path']) ?>" alt="Imagen actual" style="max-height:120px; border-radius:6px;">
    ...
    <div class="form-actions">
        ...
        <button type="submit" class="button button-primary">
            <?= $isCreate ? 'Crear noticia' : 'Guardar cambios' ?>
        </button>
    </div>
</form>
